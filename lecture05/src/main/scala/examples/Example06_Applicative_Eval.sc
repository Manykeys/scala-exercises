...
val (temperature, exchangeRate) = productExampleApp.run()
println(s"Temperature in Yekaterinburg is ${temperature.value}°C, USD to RUB rate is ${exchangeRate.value}.")
...
// Запуск комбинированного вычисления
val (moscowT, yekbT, sochiT) = mapNExampleApp.run()
