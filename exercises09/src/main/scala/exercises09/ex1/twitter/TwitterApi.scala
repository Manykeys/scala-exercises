package exercises09.ex1.twitter

import domain.TwitterError.{LikeAlreadyExistError, LikeNotExistError, TweetNotExistError}
import domain.{TweetId, TweetInfo, TwitterError, User}
